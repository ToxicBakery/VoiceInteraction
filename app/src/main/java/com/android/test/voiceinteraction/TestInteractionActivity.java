...
public class TestInteractionActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v == mAirplaneButton) {
            ...
            options[2] = new VoiceInteractor.PickOptionRequest.Option("Three", -1);
            options[3] = new VoiceInteractor.PickOptionRequest.Option("Four", -1);
            options[4] = new VoiceInteractor.PickOptionRequest.Option("Five", -1);
